        ...
        <section className="relative mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-4 py-16 text-center md:px-6 lg:py-24">
            ...
            <motion.h2 initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }} className="text-xl leading-tight tracking-wide md:text-3xl lg:text-4xl mt-6 text-white font-benguiat relative">
                ...
                <div className="relative inline-flex flex-col items-center">
                    ...
                    <span className="mt-3 text-lg sm:text-xl md:text-2xl font-benguiat text-[#FDC700] tracking-wide uppercase text-center" style={{ textShadow: "0 0 15px rgba(253, 199, 0, 0.6), 0 0 30px rgba(253, 199, 0, 0.4)" }}>
                        Build Before The Battle
                    </span>
                </div>
            </motion.h2>
            <motion.h3 initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="text-balance text-lg font-medium leading-relaxed tracking-wide md:text-2xl lg:text-3xl mt-4 text-gray-200 font-benguiat">The gate is open</motion.h3>
            <CountdownTimer />
        </section>
    )
}
